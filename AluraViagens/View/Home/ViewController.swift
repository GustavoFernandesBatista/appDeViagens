...
extension ViewController: UITableViewDataSource {
    ...
    func irParaDestalhes(_ viagem: Viagem?) {
        if let viagemSelecionada = viagem {
            let detalheController = DetalheViewController.instaciar(viagemSelecionada)
...
extension ViewController: UITableViewDelegate {
    // cada sessao criada leva ate os destaques ou os internacionais
...
extension ViewController: OfertaTableViewcCellDelegate{
